...
import com.example.cdi.chain.ChainBean013;
import com.example.cdi.chain.ChainBean027;
...
@Named("heavy02")
@Path("/heavy02")
public class HeavyController02 {
    ...
    @Inject ChainBean013 chain1;
    @Inject ChainBean027 chain2;
