...
import com.example.cdi.chain.ChainBean025;
import com.example.cdi.chain.ChainBean053;
...
@Named("heavy04")
@Path("/heavy04")
public class HeavyController04 {
    ...
    @Inject ChainBean025 chain1;
    @Inject ChainBean053 chain2;
