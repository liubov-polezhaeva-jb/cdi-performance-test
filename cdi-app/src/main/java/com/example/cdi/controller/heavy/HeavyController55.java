...
import com.example.cdi.chain.ChainBean386;
import com.example.cdi.chain.ChainBean136;
...
@Named("heavy55")
@Path("/heavy55")
public class HeavyController55 {
    ...
    @Inject ChainBean386 chain1;
    @Inject ChainBean136 chain2;
